...
힙에서 동적 메모리도 가리킬 수 있고

전역 변수도 가리킬 수 있다

그래서:

포인터 = "메모리 위치를 가리키는 화살표"

🔥 전체 정리 핵심 문장

1️⃣ main 함수 지역 변수 수명
→ main 실행 동안 유지 (프로그램 종료까지)

2️⃣ main 지역 변수 수정하려면?
→ 다른 함수가 “주소”를 받아서 수정해야 함
→ 그래서 포인터 사용

3️⃣ Call-by-address = 포인터 넘기는 방식
→ 맞다
